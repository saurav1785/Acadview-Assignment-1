...
addForm.addEventListener('submit', function (e) {
	...
	var value = addForm.querySelector('input[type="text"]').value;//uri value stored
	var li = document.createElement('li');
	var movieName = document.createElement('span');
	var deletebtn = document.createElement('span');
	li.appendChild(movieName);
	li.appendChild(deletebtn);
	list.appendChild(li);//structure is ready
	movieName.textContent = value;
	deletebtn.textContent = 'delete';
	movieName.classList.add('name');//adding class
...
//hide the list
var hidelist = document.querySelector('#add-movie #hide');
hidelist.addEventListener('click', function (e) { //doubt
...
//Search an item
var searchlist = document.forms['search-movies'][0];
searchlist.addEventListener('keyup', function (e) {
	var searchlistitem = list.querySelectorAll('li');
	...
	Array.from(searchlistitem).forEach(function (text) {
